...
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpjaHRocnRhbXJkZmtob2p0YXBjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTQ5NzQ2MjksImexciI6MjA3MDU1MDYyOX0.BlHSagKhf4uAeRVGXxCgw0804I--Rvdgkez_qBqodvg'; // Replace with your Supabase Public (anon) Key

let supabase;

function initializeAuth() {
    if (typeof Supabase === 'undefined') {
        // Supabase library not yet loaded, try again after a short delay
